...
public class Static {
    ...
    private static String districtLevelProjectTotalTestCases, projectName = null;
    ...
    public static void readStaticProperties() {
        try {
            ...
            districtLevelProjectTotalTestCases = properties.getProperty("CLASSROSTER_REPORT_TC");
